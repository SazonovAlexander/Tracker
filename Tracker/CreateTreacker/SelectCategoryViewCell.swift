...
final class SelectCategoryViewCell: UITableViewCell {
    ...
    func config(text: String, separator: Bool, topCorner: Bool, bottomCorner: Bool) {
        label.text = text
...
private extension SelectCategoryViewCell {
